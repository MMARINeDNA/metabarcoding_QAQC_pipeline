...
```{r Load metadata}
miseq_sheet <- read.csv("../metadata/SampleSheetUsed.csv",header = TRUE, sep=",",skip = 19)
sample_metadata <- read.csv("../metadata/Hake_2019_metadata.csv",row.names = NULL)
